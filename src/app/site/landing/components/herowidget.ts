...
@Component({
    ...
    template: `
        <div id="hero" class="flex flex-col pt-6 px-6 pb-12 lg:px-20 overflow-hidden bg-primary-100 dark:bg-primary-200 md:flex-row md:items-center md:justify-between rounded-border">
            <div class="mx-6 md:mx-20 mt-0 md:mt-6">
                <h1 class="text-6xl font-bold text-gray-900 leading-tight dark:!text-gray-700"><span class="font-light block">En construction</span>Ce site est un prototype, un projet personnel</h1>
